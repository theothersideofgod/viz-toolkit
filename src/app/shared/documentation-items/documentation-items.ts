  ...
  [COMPONENTS]: [
    {
      ...
      items: [
        ...
        {id: 'datepickerviewsselection', name: 'DatepickerViewsSelection', examples: ['datepicker-views-selection']},
        {id: 'datepickercustomicon', name: 'DatepickerCustomIcon', examples: ['datepicker-custom-icon']},
        {id: 'datepickerformats', name: 'DatepickerFormats', examples: ['datepicker-formats']},
        {id: 'datepickermoment', name: 'DatepickerMoment', examples: ['datepicker-moment']},
        {id: 'datepickerlocale', name: 'DatepickerLocale', examples: ['datepicker-locale']},
        {id: 'datepickerapi', name: 'DatepickerApi', examples: ['datepicker-api']},
        {id: 'datepickertouch', name: 'DatepickerTouch', examples: ['datepicker-touch']},
        {id: 'datepickerdisabled', name: 'DatepickerDisabled', examples: ['datepicker-disabled']},
        {id: 'datepickerevents', name: 'DatepickerEvents', examples: ['datepicker-events']},
        {id: 'datepickerfilter', name: 'DatepickerFilter', examples: ['datepicker-filter']},
        {id: 'datepickerminmax', name: 'DatepickerMinMax', examples: ['datepicker-min-max']},
        {id: 'datepickervalue', name: 'DatepickerValue', examples: ['datepicker-value']},
        {id: 'datepickerstartview', name: 'DatepickerStartView', examples: ['datepicker-start-view']},
        {id: 'datepickeroverview', name: 'DatepickerOverview', examples: ['datepicker-overview']},
        {id: 'treeloadmore', name: 'TreeLoadmore', examples: ['tree-loadmore']},
        {id: 'treenestedoverview', name: 'TreeNestedOverview', examples: ['tree-nested-overview']},
        {id: 'treechecklist', name: 'TreeChecklist', examples: ['tree-checklist']},
        {id: 'treeflatoverview', name: 'TreeFlatOverview', examples: ['tree-flat-overview']},
        {id: 'treedynamic', name: 'TreeDynamic', examples: ['tree-dynamic']},
        {id: 'tree', name: 'Tree', examples: ['tree']},
        {id: 'tree', name: 'Tree', examples: ['tree']},
        {id: 'dialogcontent', name: 'DialogContent', examples: ['dialog-content']},
        {id: 'dialogdata', name: 'DialogData', examples: ['dialog-data']},
        {id: 'dialogoverview', name: 'DialogOverview', examples: ['dialog-overview']},
        {id: 'dialog', name: 'Dialog', examples: ['dialog']},
        {id: 'dialog', name: 'Dialog', examples: ['dialog']},
        {id: 'dialogcontent', name: 'DialogContent', examples: ['dialog-content']},
        {id: 'dialogdata', name: 'DialogData', examples: ['dialog-data']},
        {id: 'dialogoverview', name: 'DialogOverview', examples: ['dialog-overview']},
        {id: 'snackbar', name: 'SnackBarOverview', examples: ['snack-bar-overview']},
        {id: 'snackbarcomponent', name: 'SnackBarComponent', examples: ['snack-bar-component']},
        {id: 'tabgroupanimations', name: 'TabGroupAnimations', examples: ['tab-group-animations']},
        {id: 'tabgroupalign', name: 'TabGroupAlign', examples: ['tab-group-align']},
        {id: 'tabnavbarbasic', name: 'TabNavBarBasic', examples: ['tab-nav-bar-basic']},
        {id: 'tabgroupasync', name: 'TabGroupAsync', examples: ['tab-group-async']},
        {id: 'tabgrouptheme', name: 'TabGroupTheme', examples: ['tab-group-theme']},
        {id: 'tabgroupstretched', name: 'TabGroupStretched', examples: ['tab-group-stretched']},
        {id: 'tabgrouplazyloaded', name: 'TabGroupLazyLoaded', examples: ['tab-group-lazy-loaded']},
        {id: 'tabgroupheaderbelow', name: 'TabGroupHeaderBelow', examples: ['tab-group-header-below']},
        {id: 'tabgroupdynamic', name: 'TabGroupDynamic', examples: ['tab-group-dynamic']},
        {id: 'tabgroupdynamicheight', name: 'TabGroupDynamicHeight', examples: ['tab-group-dynamic-height']},
        {id: 'tabgroupcustomlabel', name: 'TabGroupCustomLabel', examples: ['tab-group-custom-label']},
        {id: 'tabgroupbasic', name: 'TabGroupBasic', examples: ['tab-group-basic']},
        ...
        {id: 'ripples', name: 'RippleOverview', examples: ['ripple-overview']},
        ...
        {id: 'chips', name: 'Chip', examples: ['chip-basic']},
