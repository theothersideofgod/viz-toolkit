...
@Component({
  selector: 'tree-partially-loaded',
  templateUrl: 'tree-partially-loaded.component.html',
  styleUrls: ['tree-partially-loaded.component.css'],
  providers: [LoadmoreDatabase]
})
export class TreePartiallyLoadedComponent implements OnInit {
...
export const TreePartiallyLoadedData = {
  name: 'TreePartiallyLoaded'
};
